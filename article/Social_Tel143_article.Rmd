...
p1 %>% 
  ...
  readr::write_csv(path = here::here("data/derived_data/dat_p1_anzahl_anrufe.csv"))
...
p2 %>% 
  rename(anzahl_anrufe = sum_anzahl) %>% 
  readr::write_csv(path = here::here("data/derived_data/dat_p1_anzahl_anrufe_altersklasse.csv"))
...
p3 %>% 
  ...
  readr::write_csv(path = here::here("data/derived_data/dat_p1_anzahl_anrufe_beratungsinhalt.csv"))
